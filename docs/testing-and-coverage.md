...
station, diagnostic, event visibility, and administrator-boundary contracts on
the server-console-boundaries feature branch:

- 51.07% region coverage
- 47.13% line coverage
- 44.24% function coverage
