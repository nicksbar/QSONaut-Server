<script lang="ts">
  ...
  import DeploymentExtension from '$lib/DeploymentExtension.svelte';
  ...
  type Tab = 'overview' | 'clubs' | 'members' | 'events' | 'extension' | 'identities' | 'activity' | 'station' | 'profile' | 'admin' | 'admin-operations' | 'admin-identities' | 'server-data' | 'server-messages';
  ...
  <div class="console-shell">
    <aside class="console-sidebar">
      ...
      <nav class="console-nav" aria-label="Management console">
        ...
        {#if capabilities.edition !== 'community'}<button class:active={tab === 'extension'} onclick={() => openTab('extension')}><span>◇</span> Deployment extensions</button>{/if}
    ...
    <div class="console-content">
      ...
      {:else if tab === 'extension'}<DeploymentExtension {capabilities} clubs={activeMemberships} {user} initialClubId={clubScopeId} />
