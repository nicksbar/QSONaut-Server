CREATE FUNCTION award_contest_multiplier() RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
...
BEGIN
    ...
    multiplier_rule := selected_rules->'multipliers'->0;
    ...
    IF EXISTS (
        ...
        RETURN NEW;
    END IF;
    NEW.multipliers := jsonb_build_object(multiplier_key, multiplier_value);
